...
function modalDataManage(opNnum) {
  switch (opNnum) {
    ...
    case 1:
      ...
      modalText.innerHTML =
        "&nbsp;&nbsp;&nbsp;Sairaj Mane <br><br>&nbsp;&nbsp;&nbsp;Pratiksha Shinde";
      break;

    case 2:
      modalTitle.innerHTML = "About us";
      modalText.innerHTML =
        "We are beginners in developers community and enthusiasts in web development. This mini web based software is developed as the academics’ microproject, coming up with the realtime application of javascript under the Guidance of  <strong>Mr. S. P. Emekar</strong>. Your feedbacks are awaited...";
      break;
